        ...
        public void actionPerformed(ActionEvent e) {
                ...
                if (command.equals("hire")) { //if the user clicked the 'Hire' button
                        ...
                        JOptionPane.showMessageDialog(contentPane, "A new employee can be hired by clicking the 'Hire' button, entering data for the new employee, and clicking the 'Finish' button.\n"
                                        + "Employees can be fired by selecting them from the list on the left and clicking the 'Fire' button.\n"
                                        + "Any employees in the database can be viewed by selecting them from the list and clicking the 'View' button.\n"
                                        + "The list of employees can be sorted by clicking on the 'Sort...' button and selecting a type of sort.\n"
                                        + "The search bar can be used to find employees in the list.  Simply enter in the name of an employee, and click the search button to use the search function.\n"
                                        + "The total amount of salaries that will be paid out in the year can be calculated by selecting 'Calculate Salaries' under the 'File' tab.\n"
                                        + "Changes made to the database can be saved by selecting 'Save' under the 'File' tab.");
                       
                }
                else if (command.equals("about")) { //if the user clicked the 'About' menu item
                        JOptionPane.showMessageDialog(contentPane, "This program was created by Milind Bhambhani, Mengbo Kou, Spasimir Vasilev, and Chenglin Bi.");
                }
    ...
    private static double calculateSalaries() {
        ...
        private static void checkPassword() {
                ...
                while (passCount < 5) { //loops while the user has not incorrectly entered the password 5 times
                        ans = JOptionPane.showInputDialog(contentPane, "Enter password (default: 'Password'):");
                       
                        if (ans != null) { //if the user did not press 'Cancel'
                               
                                if (ans.equals(password)) { //if the correct password was entered
                                        return;
                                }
